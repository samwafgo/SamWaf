...
- ডিফল্টভাবে SQLite (এনক্রিপ্টেড), ঐচ্ছিকভাবে MySQL / PostgreSQL; সাথে বিল্ট-ইন SQLite→MySQL / SQLite→PostgreSQL / MySQL→PostgreSQL মাইগ্রেশন টুল
...
| `migratedb` | অফলাইন ডেটাবেস মাইগ্রেশন SQLite → MySQL / SQLite → PostgreSQL / MySQL → PostgreSQL (শুধু আনুমানিক হিসাবের জন্য `--dry-run`, ওভাররাইট করার জন্য `--force`) |
