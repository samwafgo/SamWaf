...
// WafVpConfigManageCDNProviderUpdateReq 管理端引用 CDN 厂商更新请求
type WafVpConfigManageCDNProviderUpdateReq struct {
	Provider string `json:"provider"` // CDN 厂商码（留空=不引用任何 CDN）
}
