...
# सॉफ़्टवेयर परिचय
SamWaf छोटी कंपनियों, स्टूडियो और व्यक्तिगत वेबसाइटों के लिए एक हल्का, ओपन-सोर्स वेब एप्लिकेशन फ़ायरवॉल है। यह पूरी तरह प्राइवेट डिप्लॉयमेंट का समर्थन करता है, डेटा को एन्क्रिप्ट करके लोकल रूप से संग्रहीत करता है, शुरू करना आसान है, और Linux, Windows 64-bit तथा ARM64 का समर्थन करता है; Docker इमेज भी उपलब्ध हैं। डिफ़ॉल्ट रूप से यह शून्य बाहरी निर्भरताओं वाले एम्बेडेड एन्क्रिप्टेड SQLite डेटाबेस का उपयोग करता है, और वैकल्पिक रूप से MySQL / PostgreSQL पर स्विच किया जा सकता है।
...
- डिफ़ॉल्ट रूप से SQLite (एन्क्रिप्टेड), वैकल्पिक MySQL / PostgreSQL, बिल्ट-इन SQLite→MySQL / SQLite→PostgreSQL / MySQL→PostgreSQL माइग्रेशन टूल के साथ
...
| `migratedb` | ऑफ़लाइन डेटाबेस माइग्रेशन SQLite → MySQL / SQLite → PostgreSQL / MySQL → PostgreSQL (`--dry-run` केवल अनुमान के लिए, `--force` ओवरराइट करने के लिए) |
